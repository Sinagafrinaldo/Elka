...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 26, 2022 at 10:49 AM
...
INSERT INTO `barang` (`id`, `nama`, `sisa`, `kategori`, `harga`, `deskripsi`, `minimal`, `maksimal`, `suplier`, `kadaluarsa`, `image`, `slug`, `tanggal_tambah`, `tanggal_edit`) VALUES
...
(16, 'Scabi', 20, 'Obat Kulit', 120000, '<p>loremm</p>', 5, 100, '', '2022-11-25', 'scabi.jpeg', 'scabi', '2022-11-14 23:33:32', '2022-11-14 23:33:32'),
(17, 'Sages', 100, 'Obat Kulit', 20000, '<p>sages</p>', 5, 100, '', '2022-12-01', 'sages.jpg', 'sages', '2022-11-14 23:34:28', '2022-11-14 23:34:28'),
(18, 'Caladine Lotion 60 ml', 22, 'Obat Kulit', 14500, '<p>Deskripsi</p><p><button _ngcontent-halodoc-c151=\"\" type=\"button\"></button></p><p>CALADINE LOTION merupakan lotion anti gatal yang mengandung Calamine, Zinc Oxyde dan Diphenhydramine HCL. Caladine lotion digunakan untuk mengobati gatal karena biang keringet, udara panas, gigitan serangga. Selain itu dapat digunakan sebagai antialergi, antideptik dan penyejuk kulit</p><p>Indikasi Umum</p><p>Mengobati gatal karena biang keringet, udara panas, gigitan serangga. Selain itu dapat digunakan sebagai antialergi, antideptik dan penyejuk kulit</p><p>Komposisi</p><p>Calamine 5 %, Zinc oxide 10%, Diphendramine Hcl 2%.</p><p>Dosis</p><p>2-4 kali sehari</p><p>Aturan Pakai</p><p>Bersihkan bagian kulit yang gatal lalu oleskan, sebaiknya digunakan sehabis mandi pagi dan sore.</p><p>Perhatian</p><p><button _ngcontent-halodoc-c151=\"\" type=\"button\"></button></p><p>Jangan dipakai pada kulit yang melepuh, mengelupas atau mengeluarkan cairan. Jika setelah memakai obat ini tidak ada perubahan, timbul rasa terbakar, ruam (iritasi) kulit, hentikan pemakaian dan periksakan ke dokter. Simpan pada suhu di bawah 30 C</p><p>Kontra Indikasi</p><p>Hipersensitif</p><p>Efek Samping</p><p><button _ngcontent-halodoc-c151=\"\" type=\"button\"></button></p><p>Pemakaian obat umumnya memiliki efek samping tertentu dan sesuai dengan masing-masing individu. Jika terjadi efek samping yang berlebih dan berbahaya, harap konsultasikan kepada tenaga medis. Efek samping yang mungkin terjadi dalam penggunaan obat adalah: Jarang terjadi : Mungkin bisa menimbulkan alergi, periksakan ke dokter bila muncul gejala alergi.</p><p>Golongan Produk</p><p>Obat Bebas Terbatas (Biru)</p><p>Kemasan</p><p>Botol @ 60 ml</p><p>Manufaktur</p><p>Galenium Pharmasia Laboratories</p><p>No. Registrasi</p><p>BPOM: DTL8327800641A1</p>', 5, 200, 'PT. Okuto', '2022-12-10', 'apotek_online_k24klik_20200908015356359225_CALADINE-LOTION.jpg', 'caladine-lotion-60-ml', '2022-11-26 16:08:03', '2022-11-26 16:19:28');
...
INSERT INTO `laporan_barangmasuk` (`id`, `nama`, `kategori`, `tanggal`, `jumlah`, `suplier`) VALUES
...
(11, 'Scabi', 'Obat Kulit', '2022-11-14 23:33:32', 20, ''),
(12, 'Sages', 'Obat Kulit', '2022-11-14 23:34:28', 100, ''),
(13, 'Caladine Lotion 60 ml', 'Obat Kulit', '2022-11-26 16:08:03', 20, 'PT. Genshin'),
(14, 'Caladine Lotion 60 ml', 'Obat Kulit', '2022-11-26 16:19:28', 2, 'PT. Okuto');
...
(12, '2022-11-18', 262000, 'November 2022');
...
(45, 'Bodrexs', 1, 8500, 8500, '2022-11-14 16:58:58'),
(46, 'Bodrexs', 1, 8500, 8500, '2022-11-14 22:43:56'),
(47, 'Insto Reguler Eye Drops 15 ml', 1, 15000, 15000, '2022-11-18 19:57:32'),
(48, 'Rohto Cool Eye Drop 7 ml', 19, 13000, 247000, '2022-11-18 19:57:51');
...
INSERT INTO `suplier` (`id`, `nama`) VALUES
(2, 'PT. Hari bumi'),
(3, 'PT.Kontoru'),
(4, 'Kimia Farma'),
(5, 'Antara'),
