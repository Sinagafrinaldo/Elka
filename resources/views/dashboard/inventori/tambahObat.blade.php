...
<title>Tambah Produk || Elka Farma</title>
...
<div class="mx-4 mt-2">
    <div class="over">
        <div class="d-flex w-over">
            ...
            <i class="mt-2 mx-3 fa-solid fa-chevron-right text-dark"></i>
            <a href="{{ route('admin.inputObat') }}" class="text-decoration-none text-dark fw-bold fs-4">Tambah Produk</a>
        </div>
    </div>
    ...
    <form action="/admin/input-obat/store" method="post" enctype="multipart/form-data">
        ...
        <div class="row mb-3">
            <div class="col">
                ...
                <textarea name="deskripsi" id="konten" class="form-control" name="konten" rows="10" cols="50"
                    required></textarea>
            </div>
        </div>
        <div class="row mb-3">
